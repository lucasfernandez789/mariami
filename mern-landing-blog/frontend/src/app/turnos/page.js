...
export default function TurnosPage() {
  const { user, login, isAuthenticated, loading, logout } = useAuth();
      ...
      <section className="flex-1 flex flex-col justify-center items-center py-16">
        {loading ? (
          <div className="flex flex-col items-center justify-center min-h-[300px]">
            ...
            <p className="text-pink-500 font-semibold">Cargando...</p>
          </div>
        ) : !isAuthenticated ? (
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 max-w-md w-full text-center">
            <div className="text-6xl mb-4">🔐</div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Inicia sesión para reservar tu turno</h2>
            <p className="text-gray-600 mb-6">Usa tu cuenta de Google para un proceso más rápido y seguro.</p>
            <button
              onClick={handleLogin}
              className="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center mb-4"
            >
